...
const LazyTasksInProgressPage = lazy(() =>
	import('./TasksInProgressPage').then((module) => ({
		default: module.TasksInProgressPage,
	}))
);

const TasksInProgressPage = (
	props: JSX.IntrinsicAttributes & { children?: React.ReactNode }
) => {
	//здесь подключение данных
	return (
		<Suspense fallback={null}>
			<LazyTasksInProgressPage {...props} />
		</Suspense>
	);
};
