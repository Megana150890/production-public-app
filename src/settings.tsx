import { Icon } from '@charitypro/ui-kit';
	...
	columns: [
		{
			...
			links: [
				...
				{ linkTitle: 'Документы', url: '/about_project/documents_and_requisites' },
		...
		},
		{
			columnTitle: 'Фондам',
			links: [
				{ linkTitle: 'Как получить помощь', url: '/foundations/how_to_get_help' },
